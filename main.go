...
func init() {
	...
	utilruntime.Must(osrmv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "746cc0df.itayankri",
	})
	if err != nil {
	...
	if err = (controllers.NewOSRMInstanceReconciler(mgr.GetClient(), mgr.GetScheme())).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "OSRMInstance")
		os.Exit(1)
	}
