...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OSRMInstance) DeepCopyInto(out *OSRMInstance) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	in.Spec.DeepCopyInto(&out.Spec)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OSRMInstance.
func (in *OSRMInstance) DeepCopy() *OSRMInstance {
	if in == nil {
		return nil
	}
	out := new(OSRMInstance)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *OSRMInstance) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OSRMInstanceList) DeepCopyInto(out *OSRMInstanceList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]OSRMInstance, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OSRMInstanceList.
func (in *OSRMInstanceList) DeepCopy() *OSRMInstanceList {
	if in == nil {
		return nil
	}
	out := new(OSRMInstanceList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *OSRMInstanceList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OSRMInstanceSpec) DeepCopyInto(out *OSRMInstanceSpec) {
	*out = *in
	if in.Replicas != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OSRMInstanceSpec.
func (in *OSRMInstanceSpec) DeepCopy() *OSRMInstanceSpec {
	if in == nil {
		return nil
	}
	out := new(OSRMInstanceSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OSRMInstanceStatus) DeepCopyInto(out *OSRMInstanceStatus) {
	*out = *in
	if in.Conditions != nil {
		in, out := &in.Conditions, &out.Conditions
		*out = make([]metav1.Condition, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OSRMInstanceStatus.
func (in *OSRMInstanceStatus) DeepCopy() *OSRMInstanceStatus {
	if in == nil {
		return nil
	}
	out := new(OSRMInstanceStatus)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OSRMRoutedOptions) DeepCopyInto(out *OSRMRoutedOptions) {
	*out = *in
	if in.MaxViaRouteSize != nil {
		in, out := &in.MaxViaRouteSize, &out.MaxViaRouteSize
		*out = new(int32)
		**out = **in
	}
	if in.MaxTripSize != nil {
		in, out := &in.MaxTripSize, &out.MaxTripSize
		*out = new(int32)
		**out = **in
	}
	if in.MaxTableSize != nil {
		in, out := &in.MaxTableSize, &out.MaxTableSize
		*out = new(int32)
		**out = **in
	}
	if in.MaxMatchingSize != nil {
		in, out := &in.MaxMatchingSize, &out.MaxMatchingSize
		*out = new(int32)
		**out = **in
	}
	if in.MaxNearestSize != nil {
		in, out := &in.MaxNearestSize, &out.MaxNearestSize
		*out = new(int32)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OSRMRoutedOptions.
func (in *OSRMRoutedOptions) DeepCopy() *OSRMRoutedOptions {
	if in == nil {
		return nil
	}
	out := new(OSRMRoutedOptions)
